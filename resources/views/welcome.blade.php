...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <link rel="stylesheet" href="/vendor/dropzone-5.5.0/dist/basic.css">

        <script src="/vendor/jquery.min.js"></script>
        <script src="/vendor/dropzone-5.5.0/dist/dropzone.js"></script>
    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="drop_area">
                    <form action="{{ url('/photos')}}" enctype="multipart/form-data" method="POST" class="dropzone" id="my-dropzone">
                        {{ csrf_field() }}
